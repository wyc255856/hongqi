...
public class BigPointView extends LinearLayout {
    private Activity mContext;
    ImageView iv1, iv2;

    public BigPointView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);

    }

    public BigPointView(Context context) {
        super(context);
        initView(context);
    }
    ...
    private void initView(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.view_big_point,
                this, true);
