...
import com.faw.e115.ui.E115ContentActivity;
...
//        EventBus.getDefault().post(new SecondaryOnclickEvent(SecondaryOnclickEvent.FAST, index));
        if (data.getStatus() == 0) {
            mContext.startActivity(new Intent(mContext, E115PlayVideoActivity.class));
        } else {
            E115ContentActivity.goContentActivity(mContext, data);
        }
